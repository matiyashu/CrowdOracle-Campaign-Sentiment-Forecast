"""
Validate that Profile format generation meets OASIS requirements.
Checks:
1. Twitter profiles serialize to the expected CSV format.
2. Reddit profiles serialize to the expected detailed JSON format.
"""
...
def test_profile_formats():
    """Test that the profile generator produces the required formats."""
    print("=" * 60)
    print("OASIS Profile format test")
    print("=" * 60)

    # Build two sample profiles
    test_profiles = [
        OasisAgentProfile(
            user_id=0,
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        # Read back and validate the CSV
        ...
        # Read back and validate the JSON
...
def show_expected_formats():
    """Print the OASIS-expected profile formats for reference."""
    print("\n" + "=" * 60)
    print("OASIS expected Profile formats (reference)")
    print("=" * 60)
