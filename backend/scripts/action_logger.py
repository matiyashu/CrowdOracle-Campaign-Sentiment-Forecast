...
Captures per-agent actions so the backend can monitor progress.
...
Log layout:
    ...
    └── run_state.json       # Run-state snapshot (used by the API)
"""
...
class PlatformActionLogger:
    """Action logger for a single platform (Twitter or Reddit)."""
    ...
    def __init__(self, platform: str, base_dir: str):
        ...
        Args:
            ...
            base_dir: Base directory of the simulation run
        """
...
class SimulationLogManager:
    ...
    Unifies management of all log files, split by platform.
    """
    ...
    def __init__(self, simulation_dir: str):
        ...
        Args:
            simulation_dir: Root directory of the simulation run
        """
    ...
    def _setup_main_logger(self):
        """Configure the main simulation-process logger."""
    ...
    def get_twitter_logger(self) -> PlatformActionLogger:
        """Return the Twitter platform logger (lazy-initialised)."""
    ...
    def get_reddit_logger(self) -> PlatformActionLogger:
        """Return the Reddit platform logger (lazy-initialised)."""
    ...
    def log(self, message: str, level: str = "info"):
        """Write to the main logger at the given level."""
...
class ActionLogger:
    """
    Legacy action logger (kept for backward compatibility).
    New code should use SimulationLogManager instead.
    """
...
def get_logger(log_path: Optional[str] = None) -> ActionLogger:
    """Return the global logger instance (legacy compatibility)."""
