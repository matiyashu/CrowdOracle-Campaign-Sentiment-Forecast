...
class Project:
    ...
    # Ontology info (populated after step 1)
...
class ProjectManager:
    ...
    # Root storage directory for all projects
    ...
    def _get_project_files_dir(cls, project_id: str) -> str:
        """Return the directory that stores uploaded files for a project."""
    ...
    def save_extracted_text(cls, project_id: str, text: str) -> None:
        """Persist the extracted text for a project."""
    ...
    def get_extracted_text(cls, project_id: str) -> Optional[str]:
        """Load the extracted text for a project, or None if not yet extracted."""
        text_path = cls._get_project_text_path(project_id)
    ...
    def get_project_files(cls, project_id: str) -> List[str]:
        """Return the absolute paths of all uploaded files for a project."""
        files_dir = cls._get_project_files_dir(project_id)
